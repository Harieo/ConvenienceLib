 ...
 * the provided player. In most cases, you will not need to use this class as it is done for you, unless you are using
 * a more advanced implementation of the Spigot {@link Scoreboard} API.
 */
class GameBoardImpl {
